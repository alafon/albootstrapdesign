...
<div class="row ezcom-add" id="CommentAdd">
    <div class="span12">
    ...
    {def $titleRequired = ezini( 'title', 'Required', 'ezcomments.ini' )|eq( 'true' )}
        <div class="ezcom-field ezcom-field-title clearfix">
            <label>
    ...
    {def $nameRequired = ezini( 'name', 'Required', 'ezcomments.ini' )|eq( 'true' )}
        <div class="ezcom-field ezcom-field-name clearfix">
    ...
    {def $websiteRequired = ezini( 'website', 'Required', 'ezcomments.ini' )|eq( 'true' )}
        <div class="ezcom-field ezcom-field-website clearfix">
            <label>
    ...
    {def $emailRequired = ezini( 'email', 'Required', 'ezcomments.ini' )|eq( 'true' )}
        <div class="ezcom-field ezcom-field-email clearfix">
            <label>
    ...
    <div class="ezcom-field ezcom-field-content clearfix">
        <label>
            {'Content:'|i18n( 'ezcomments/comment/add/form' )}{$fieldRequiredText}
        </label>
        <div class="input">
        <textarea class="box span8" name="CommentContent" rows="3" cols=""></textarea>
        </div>
    </div>
    ...
    {if $fields|contains( 'notificationField' )}
        ...
        {if or( $fields|contains( 'email' ), and( $fields|contains( 'email' )|not, $is_anonymous|not ) )}
            <div class="ezcom-field ezcom-field-notified clearfix">
                <div class="input">
                    <ul class="inputs-list">
                        <li>
                        <label> 
                            <input type="checkbox" name="CommentNotified" {if $comment_notified|eq('true')}checked="checked"{/if} value="1" />
                            <span>{'Notify me of new comments'|i18n( 'ezcomments/comment/add/form' )}</span>
                        </label>
                        </li>
                    </ul>
                </div>
            ...
            <div class="ezcom-field clearfix">
              ...
              {else}
                  ...
                  {if $theme|eq('custom')}
                      ...
                      <div id="recaptcha_image" class="input"></div>
                      <p>
    ...
    {/if}
    {if $is_anonymous}
        <div class="ezcom-field ezcom-field-remember clearfix">
            <label>
    ...
    {/if}
    <div class="ezcom-field actions">
        <input type="submit" value="{'Add comment'|i18n( 'ezcomments/comment/add/form' )}" class="btn primary button" name="AddCommentButton" />
        <input type="reset" class="btn button" value="{'Reset form'|i18n( 'ezcomments/comment/add/form' )}" />
    </div>
    </div>
</div>
</form>
